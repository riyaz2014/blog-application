<template>
    <header>
                    ...
                    <div v-show="profileMenu" class="profile-menu">
                        ...
                        <div class="options">
                            ...
                            <div @click="signOut" class="option">
                                <img class="icon" src="../assets/Icons/sign-out-alt-regular.svg"  alt=""/>
                                <p>Sign Out</p>
                            </div>
                        </div>
                    </div>
        ...
        <img v-show="mobile" @click="toggleMobileNav" src="../assets/Icons/bars-regular.svg" alt="" class="menu-icon">
